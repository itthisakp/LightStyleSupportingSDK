...
//! Project version number for LightStyleSupportingSDK.
FOUNDATION_EXPORT double LightStyleSupportingSDKVersionNumber;

//! Project version string for LightStyleSupportingSDK.
